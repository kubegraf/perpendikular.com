...
// generated once at build time — the export has no server to render it
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ position: "absolute", left: 32, top: 117, width: 52, height: 9, background: "#edeff3", borderRadius: 5, transform: "rotate(-45deg)" }} />
